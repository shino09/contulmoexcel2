...
public function getDocument($id)
{
    ...
    //File::mimeType($filePath)='application/vnd.openxmlformats-officedocument.wordprocessingml.document';
    //print_r($type) ;die();
	$fileName=$filePath;
	//print_r($type);die();
...
//print_r($htmlWriter);die();
$wordcontent = File::get('temporal.html');
$contenido=$wordcontent;
//print_r($wordcontent);

//return \View::make("persona.pdf")->with("nombre",$fileName,"contenido", $contenido);
 return view('persona.pdf',compact('nombre','contenido'));
       // return view('alumno.show2',compact('alumno','id','universidads'));    }

		//return view('persona.pdf',compact('contenido'));
